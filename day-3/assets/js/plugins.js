...
jQuery(document).ready(function(s) {
    ...
    function u(i) {
        ...
        } else i.parents(".animated-headline").hasClass("clip") ? i.parents(".words-wrapper").animate({
            width: "2px"
        }, c, function() {
            w(i, e), f(e)
        }) : i.parents(".animated-headline").hasClass("loading-bar") ? (i.parents(".words-wrapper").removeClass("is-loading"), w(i, e), setTimeout(function() {
            u(e)
        }, n), setTimeout(function() {
            i.parents(".words-wrapper").addClass("is-loading")
    ...
    function f(s, i) {
        s.parents(".animated-headline").hasClass("type") ? (m(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".animated-headline").hasClass("clip") && s.parents(".words-wrapper").animate({
            width: s.width() + 10
        }, c, function() {
            setTimeout(function() {
                u(s)
    ...
    function m(s, i, e, a) {
        s.addClass("in").removeClass("out"), s.is(":last-child") ? (i.parents(".animated-headline").hasClass("type") && setTimeout(function() {
            i.parents(".words-wrapper").addClass("waiting")
    ...
    s(".animated-headline.letters").find("b").each(function() {
        var e = s(this),
            a = e.text().split(""),
    ...
    }), e = s(".animated-headline"), a = t, e.each(function() {
        var i = s(this);
        if (i.hasClass("loading-bar")) a = n, setTimeout(function() {
            i.find(".words-wrapper").addClass("is-loading")
        }, d);
        else if (i.hasClass("clip")) {
            var e = i.find(".words-wrapper"),
                t = e.width() + 10;
            e.css("width", t)
        } else if (!i.hasClass("type")) {
            var r = i.find(".words-wrapper b"),
                l = 0;
            r.each(function() {
                var i = s(this).width();
                i > l && (l = i)
            }), i.find(".words-wrapper").css("width", l)
        }
        setTimeout(function() {
    ...
    m.prototype.init = function() {
        ...
        e(f).each(function() {
            ...
            t.children("a").attr("role", "menuitem").click(function(t) {
                h.closeOnClick && !e(t.target).parent().closest("li").hasClass(s + "_parent") && e("#menu-button").click()
